...
# [jonex] Fail-fast guard: workspace-override env vars force all KBs into a
...
def validate_workspace_isolation_config() -> None:
    ...
    They must never be set in the jonex-platform deployment.
    """
    violations = [
...
def parse_args() -> argparse.Namespace:
    ...
    # [jonex] Reject storage-level workspace overrides that silently collapse isolation
