...
Community maintainers are responsible for clarifying and enforcing these standards and may remove, edit, or reject comments, commits, code, issues, and other contributions that are not aligned with this Code of Conduct.
...
2. **Warning** — A warning with consequences for continued behavior and a temporary restriction on interaction when appropriate.
3. **Temporary ban** — A temporary ban from community interaction for a sustained or serious violation.
4. **Permanent ban** — Permanent removal for repeated violations, harassment, or aggression toward individuals or groups.
