      ...
      await route.fulfill({
        ...
        body: JSON.stringify({
          ...
          data: {
            ...
            relation_distribution: [{ label: 'default', count: 134, pct: 100 }],
          },
        }),
      });
    });
            ...
            items: [
              {
                ...
                source_id: '',
                file_path: 'kb=...|doc=...|tenant=test_tenant|file=test.md|chunk=0',
              ...
              },
              {
                ...
                source_id: '',
                file_path: 'kb=...|doc=...|tenant=test_tenant|file=test.md|chunk=1',
